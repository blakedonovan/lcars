<template>
    <div class="floorplan">
        <svg viewBox="0 0 58.06 84.61" width="100%" height="100%">
            <g class="raum">
                <path d="M57.56,.5h-19.91V14.93c-8.82-.42-13.57-5.15-14.04-14.43H.5V83.1H57.56V.5Z" />
                <rect x="27.72" y="60.25" width="2.63" height="45.1" transform="translate(-53.76 111.83) rotate(-90)" />
            </g>
            <g class="tisch">
